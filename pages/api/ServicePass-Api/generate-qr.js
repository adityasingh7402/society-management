...
export default async function handler(req, res) {
  ...
  try {
    const { qrData, societyName, flatNumber, personnelName, serviceType, workingHours, validDates } = req.body;
    ...
    ctx.fillText(`${serviceType}: ${personnelName}`, 600, 1220);
    ctx.fillText(`Working Hours: ${workingHours}`, 600, 1280);
    ctx.fillText(validDates, 600, 1340);
